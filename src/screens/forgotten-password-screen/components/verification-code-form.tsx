...
const VerificationCodeForm: React.FC<IVerificationCodeFormProps> = ({ onSuccess, email }) => {
  const { isLoading: isVerifyingEmail, mutate: sendResetPassword } = useMutation(
    ['reset-password'],
    (code: string) => {
  ...
  return (
    <>
      ...
      <Typography align="center" variant="subtitle2" sx={{ width: '95%', mt: 2, mb: 3 }}>
